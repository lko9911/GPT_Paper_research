...
KEYWORDS = {
    ...
    "Computational Design": ["computational design", "design automation", "generative design"],
...
TAG_MAP = {
    ...
    "Computational design": ["computational design", "generative design"],
    "Material distribution": ["material distribution", "topology optimization"],
    "Path planning": ["path planning", "graph search", "routing"],
    "Machine learning": ["machine learning", "deep learning", "neural", "artificial intelligence", "inverse design", "inverse-designed", "inverse designed"],
