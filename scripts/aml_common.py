...
def public_paper(record: dict[str, Any], updated_at: str) -> dict[str, Any]:
    ...
    return {
        ...
        "openalex_venue_rank": record.get("openalex_venue_rank", ""),
        "openalex_venue_rank_number": record.get("openalex_venue_rank_number"),
        "openalex_venue_rank_score": record.get("openalex_venue_rank_score"),
        "openalex_venue_rank_percentile": record.get("openalex_venue_rank_percentile"),
        "openalex_venue_rank_basis": record.get("openalex_venue_rank_basis", ""),
