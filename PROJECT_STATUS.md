...
# 2026-06-18 AML Recommendation Engine

## Current Status
- Existing scheduled keyword update workflow remains `.github/workflows/update-papers.yml` and was not modified.
- A separate manual-only AML workflow was added at `.github/workflows/aml-recommendation-manual.yml`.
- AML recommendations are generated by `scripts/run_aml_recommendation_pipeline.py`.
