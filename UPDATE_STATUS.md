...
- Checked at: `2026-06-28T01:23:14+09:00` KST
- Workflow: `Update papers`
- Event: `schedule`
- Run: [28292664432](https://github.com/lko9911/GPT_Paper_research/actions/runs/28292664432)
- Job status: `success`
- Update step: `success`
- Commit step: `success`
- Deploy step: `success`
...
- Ref: `main`
- Commit SHA: `29f2e8026dd6ab808ff966a016f658e3fc28b568`

## Last Successful Collection

- Last collection time: `2026-06-27 23:55:12 KST`
- Curated papers: `1520`
- Raw candidates: `2020`
- Archived hidden: `500`
- Papers added in last `7` days: `828`
- Papers added in last successful run: `0` (raw rebuild count: `1520`; mode: `full_rebuild_crossref_only`)
