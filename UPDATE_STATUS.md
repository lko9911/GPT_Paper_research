...
- Checked at: `2026-06-26T02:14:11+09:00` KST
- Workflow: `Update papers`
- Event: `schedule`
- Run: [28182367896](https://github.com/lko9911/GPT_Paper_research/actions/runs/28182367896)
- Job status: `success`
- Update step: `success`
- Commit step: `success`
- Deploy step: `success`
...
- Ref: `main`
- Commit SHA: `5d97d32b60309ce4f37c8f8608dd35805047f5a0`

## Last Successful Collection

- Last collection time: `2026-06-26 00:45:25 KST`
- Curated papers: `2058`
- Raw candidates: `2124`
- Archived hidden: `66`
- Papers added in last `7` days: `1247`
- Papers added in last successful run: `0` (raw rebuild count: `2058`; mode: `full_rebuild_crossref_only`)
