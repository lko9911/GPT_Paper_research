...
- Checked at: `2026-06-30T21:55:15+09:00` KST
- Workflow: `Update papers`
- Event: `schedule`
- Run: [28438118896](https://github.com/lko9911/GPT_Paper_research/actions/runs/28438118896)
- Job status: `success`
- Update step: `success`
- Commit step: `success`
- Deploy step: `success`
...
- Ref: `main`
- Commit SHA: `6f1f85c3e8160db62a16b8e3924194587e669649`

## Last Successful Collection

- Last collection time: `2026-06-30 19:36:11 KST`
- Curated papers: `1468`
- Raw candidates: `1975`
- Archived hidden: `507`
- Papers added in last `7` days: `734`
- Papers added in last successful run: `0` (raw rebuild count: `1468`; mode: `full_rebuild_crossref_only`)
