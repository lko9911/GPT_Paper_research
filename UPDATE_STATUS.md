...
- Checked at: `2026-06-28T14:44:11+09:00` KST
- Workflow: `Update papers`
- Event: `schedule`
- Run: [28312881633](https://github.com/lko9911/GPT_Paper_research/actions/runs/28312881633)
...
- Ref: `main`
- Commit SHA: `f61ea34c9062bd0810569d4794b4f39e171258d7`

## Last Successful Collection

- Last collection time: `2026-06-28 05:19:28 KST`
- Curated papers: `1519`
- Raw candidates: `2017`
- Archived hidden: `498`
- Papers added in last `7` days: `827`
- Papers added in last successful run: `0` (raw rebuild count: `1519`; mode: `full_rebuild_crossref_only`)
