...
- Checked at: `2026-06-21T00:43:16+09:00` KST
- Workflow: `Update papers`
- Event: `schedule`
- Run: [27875156834](https://github.com/lko9911/GPT_Paper_research/actions/runs/27875156834)
- Job status: `success`
- Update step: `success`
- Commit step: `success`
- Deploy step: `success`
...
- Ref: `main`
- Commit SHA: `9482379bd64e1ec03b44d16129bc6e49b0dfb48f`

## Last Successful Collection

- Last collection time: `2026-06-21 00:13:37 KST`
- Curated papers: `1236`
- Raw candidates: `1288`
- Archived hidden: `52`
- Papers added in last `7` days: `389`
- Papers added in last successful run: `0` (raw rebuild count: `1236`; mode: `full_rebuild_crossref_only`)
